...
require("lazy").setup({
	...
	-- -------------------------------------------------------------------------
	{
		...
		config = function()
			...
			-- -----------------------------------------------------------------------
			vim.lsp.enable({ "zuban", "denols", "clangd", "rust_analyzer" })
...

	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ft", builtin.treesitter, { desc = "Telescope tree-sitter document symbols" })
			...
			end, { desc = "Telescope LSP document functions" })
			vim.keymap.set(
				"n",
				"<leader>fS",
			...
			vim.keymap.set("n", "<leader>fN", function()
				builtin.lsp_workspace_symbols({ symbols = { "function" } })
...

	{
		...
		config = function()
			vim.keymap.set("n", "<leader>cf", require("conform").format, { desc = "Format using conform" })
		end,
	},
